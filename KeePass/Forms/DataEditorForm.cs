	...
	public partial class DataEditorForm : Form
	{
		...
		private void OnFormClosing(object sender, FormClosingEventArgs e)
		{
				...
				!MemUtil.ArraysEqual(m_pbEditedData, m_pbData))
			{
				...
				string strMsg = KPRes.URtfProblem + StrUtil.NewParagraph +
					KPRes.URtfCheck + StrUtil.NewParagraph +
					KPRes.URtfSuggestion + StrUtil.NewParagraph +
					KPRes.MoreInfo + ":" + StrUtil.NewLine;
